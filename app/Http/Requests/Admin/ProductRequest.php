...
class ProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'thumbnail' => $this->isMethod('POST') && !$this->id ? 'required|image|mimes:jpeg,png,jpg|max:2048' : 'nullable|image|mimes:jpeg,png,jpg|max:2048',
            ...
            'variant.*.sku' => 'required|string|unique:product_variants,sku',
            'variant.*.image' => 'nullable|image|mimes:jpeg,png,jpg|max:2048',
            'existing_variant' => 'nullable|array',
            'existing_variant.*.id' => 'required|integer|exists:product_variants,id',
