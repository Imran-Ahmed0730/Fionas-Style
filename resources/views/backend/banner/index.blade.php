    ...
    <div class="container">
        <div class="page-inner">
            <div class="page-header">
                <h3 class="fw-bold mb-3">View Banners</h3>
                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-header d-flex align-items-center">
                            <h3 class="card-title mb-0">View Banners</h3>
                            @can('Banner Add')
                                <a href="{{route('admin.banner.create')}}" data-bs-toggle="tooltip" title="Add Banner" class="btn btn-primary ms-auto">
                                ...
                                @foreach($items as $key => $item)
                                    <tr class="align-middle">
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                @can('Banner Update')
                                                    <a href="{{route('admin.banner.edit', $item->id)}}" data-bs-toggle="tooltip" title="Edit" class="btn btn-primary me-2"><i class="fa fa-pencil"></i></a>
                                                @endcan
                                                @can('Banner Delete')
