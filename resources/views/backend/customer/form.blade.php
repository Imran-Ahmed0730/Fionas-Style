...
@section('title')
    @isset($item)Edit @else Add @endisset Customer
@endsection
@push('css')
    ...
    <div class="container">
        <div class="page-inner">
            <div class="page-header">
                <h3 class="fw-bold mb-3">@isset($item)Edit @else Add @endisset Customer</h3>
            ...
            <div class="row">
                <form action="@isset($item){{route('admin.customer.update')}}@else{{route('admin.customer.store')}}@endisset" method="post" enctype="multipart/form-data">
                    @csrf<!--begin::Body-->
