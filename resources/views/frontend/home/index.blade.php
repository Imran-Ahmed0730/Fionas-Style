...
@section('content')
    ...
    <section class="hero-section">
        <div class="hero-items owl-carousel">
            ...
            <div class="single-hero-items set-bg" data-setbg="{{asset('frontend')}}/assets/img/hero-2.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-5">
                            <span>Bag,kids</span>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="single-banner">
                        <img src="{{asset('frontend')}}/assets/img/banner-1.jpg" alt="">
                ...
                <div class="col-lg-4">
                    <div class="single-banner">
                        <img src="{{asset('frontend')}}/assets/img/banner-2.jpg" alt="">
                        <div class="inner-text">
                            <h4>Women’s</h4>
                        </div>
                    </div>
                ...
                <div class="col-lg-4">
                    <div class="single-banner">
                        <img src="{{asset('frontend')}}/assets/img/banner-3.jpg" alt="">
                        <div class="inner-text">
                            <h4>Kid’s</h4>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="product-slider owl-carousel">
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="{{asset('frontend')}}/assets/img/products/man-1.jpg" alt="">
                                <div class="sale">Sale</div>
                                <div class="icon">
                                    <i class="icon_heart_alt"></i>
                                </div>
                        ...
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="{{asset('frontend')}}/assets/img/products/man-2.jpg" alt="">
                                <div class="icon">
                                    <i class="icon_heart_alt"></i>
                                </div>
                                <ul>
                        ...
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="{{asset('frontend')}}/assets/img/products/man-3.jpg" alt="">
                                <div class="icon">
                                    <i class="icon_heart_alt"></i>
                                </div>
                                <ul>
                        ...
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="{{asset('frontend')}}/assets/img/products/man-4.jpg" alt="">
                                <div class="icon">
                                    <i class="icon_heart_alt"></i>
                                </div>
                                <ul>
