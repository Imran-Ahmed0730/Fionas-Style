                        ...
                        <form action="{{ route('search') }}" method="GET">
                            <div class="advanced-search">
                                <select name="type" class="category-btn">
                                    <option value="product" {{ request('type') == 'product' ? 'selected' : '' }}>All
                                        Products
                                    </option>
                                    <option value="category" {{ request('type') == 'category' ? 'selected' : '' }}>All
                                        Categories
                                    </option>
                            ...
                            <li class="heart-icon">
                                <a href="{{ route('customer.wishlist.index') }}">
                                    ...
                                    <span id="wishlistCount">
                                        @auth
                                            {{ \App\Models\Frontend\Wishlist::where('user_id', auth()->id())->count() }}
                                        @else
                                            0
                                        @endauth
                                    </span>
