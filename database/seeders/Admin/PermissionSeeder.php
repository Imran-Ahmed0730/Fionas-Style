...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $permissions = [
            ...
            "Email Template Title Edit",
            "Email Template Update",
            "Email Template View",
            "Frontend-Page Add",
            "Frontend-Page Delete",
            ...
            "Order Online View",
            "Order Online Update",
            "Order Online Payment Add",
            "Order POS View",
            "Order POS Update",
            "Order POS Payment Add",
